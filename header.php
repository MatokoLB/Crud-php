...
<header class="conteiner p-2 bg-info mb-4">
  <nav class="navbar">
    <div class="d-flex ">
      <div>
        <a href="listagem.php" class="btn btn-ligh d-flex align-items-center text-light">
      ...
      <a href="inclusao.php" class="btn btn-primary">
        <i> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
    ...
    <div class="div">
      ...
      <label for="theme">
        <i class="light_theme "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
        ...
        <i class="dark_theme "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
...
<script>
  $(document).ready(function() {
    ...
    changeThemeBtn.on("change", function() {
      toggleDarkMode();

      // Salve/remove darkTheme do localStorage
